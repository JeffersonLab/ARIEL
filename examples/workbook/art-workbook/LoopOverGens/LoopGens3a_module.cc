...
namespace tex {
  ...
  class LoopGens3a : public art::EDAnalyzer {

  public:

    explicit LoopGens3a(fhicl::ParameterSet const& );
...
tex::LoopGens3a::LoopGens3a(fhicl::ParameterSet const& pset ):
  art::EDAnalyzer(pset),
...
void tex::LoopGens3a::analyze(art::Event const& event ){
...
// end tex::LoopGens3a::analyze

DEFINE_ART_MODULE(tex::LoopGens3a)
