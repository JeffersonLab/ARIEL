...
tex::FittedHelixData::FittedHelixData() : helix_(), cov_(Helix::dim, 0), hits_()
{}
...
std::ostream&
tex::operator<<(std::ostream& ost, const tex::FittedHelixData& fit)
{
  ost << "( cu: " << fit.helix().cu() << " phi0: " << fit.helix().phi0()
      << " d0: " << fit.helix().d0() << " ct: " << fit.helix().ct()
      << " z0: " << fit.helix().z0() << " )" << std::endl;
