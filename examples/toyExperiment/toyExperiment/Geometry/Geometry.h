...
//
// Hold the geometry description and make it available to modules and to other services.
//
...
public:
    ...
    std::vector<double> const& worldHalfLengths() const { return _worldHalfLengths; }
