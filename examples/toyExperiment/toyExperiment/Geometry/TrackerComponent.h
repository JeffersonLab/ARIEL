...
//
// Notes
// 1) inner and outer will be used as indices into std::vectors, so they must be 0 based.
//    Therefore we need to use the EnumToStringSparse, not EnumToString, which requires
//    that the unknown enum value be 0.
//
