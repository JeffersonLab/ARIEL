#ifndef fhiclcpp_detail_ValuePrinter_h
#define fhiclcpp_detail_ValuePrinter_h
...
namespace fhicl::detail {
  ...
  class ValuePrinter : public ParameterSetWalker {
  public:
...
#endif /* fhiclcpp_detail_ValuePrinter_h */
