...
namespace arttest {
  ...
  private:
    ...
    beginRun(art::Run& r) override
    {
      ...
      r.put(
        std::make_unique<StringProduct>("beginRun"), "bgnRun", art::fullRun());
    }
    ...
    beginSubRun(art::SubRun& sr) override
    {
      ...
      sr.put(std::make_unique<StringProduct>("beginSubRun"),
             "bgnSubRun",
             art::fullSubRun());
    }
    ...
    {
      r.put(
        std::make_unique<StringProduct>("endRun"), "endRun", art::fullRun());
    }
