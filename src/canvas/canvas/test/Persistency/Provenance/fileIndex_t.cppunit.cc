...
void
testFileIndex::constructAndInsertTest()
{
...
void
testFileIndex::eventSortAndSearchTest()
{
...
void
testFileIndex::eventEntrySortAndSearchTest()
{
...
void
testFileIndex::eventsUniqueAndOrderedTest()
{
...
bool
testFileIndex::areEntryVectorsTheSame(art::FileIndex& i1, art::FileIndex& i2)
{
  if (i1.size() != i2.size())
    return false;
