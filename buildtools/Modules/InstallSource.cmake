...
macro( _cet_copy_fcl )
  ...
  set( fclbuildpath ${PROJECT_BINARY_DIR}/${fclpathname} )
...
macro( install_source   )
  ...
  if( JERM_INSTALL_SRCDIR )
    set(source_install_dir ${JERM_INSTALL_SRCDIR}${CURRENT_SUBDIR} )
  else()
    set(source_install_dir src/${product}/${version}${CURRENT_SUBDIR} )
  endif()
...
macro( _cet_copy_gdml )
  ...
  set( gdmlbuildpath ${PROJECT_BINARY_DIR}/${gdmlpathname} )
  if( CPGDML_SUBDIR )
...
macro( _cet_copy_fw )
  ...
  set( fwbuildpath ${PROJECT_BINARY_DIR}/${fwpathname} )
  if( CPFW_SUBDIRNAME )
